...
public class ListagemUsuariosController {
    ...
    private void carregarUsuariosTabela() throws SQLException {
        ...
        ObservableList<Usuario> lista = FXCollections.observableArrayList(listarUsuarios());
        if(!lista.isEmpty()){
            ...
            colunaPerfil.setStyle("-fx-alignment: CENTER;");
            
            tabelaUsuarios.getColumns().addAll(colunaID, colunaNome, colunaFone, colunaLogin, colunaPerfil);
    ...
    //metodo para buscar do banco de dados
